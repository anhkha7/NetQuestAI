    ...
    <div className="min-h-screen cyber-grid flex items-center justify-center px-4 pt-16">
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center bg-gradient-to-br from-[var(--color-neon-green)] to-[var(--color-neon-cyan)]">
            <span className="text-2xl font-black text-[var(--color-bg-primary)]">NQ</span>
          </div>
          <h1 className="text-3xl font-bold mb-2">
            Welcome <span className="gradient-text-green-cyan">back</span>
          </h1>
